...
class MTNMomoPage extends StatefulWidget {
  const MTNMomoPage({super.key});

  @override
  State<MTNMomoPage> createState() => _MTNMomoPageState();
}
                        ...
                        Container(
                          ...
                          child: Column(
                            children: [
                              ...
                              Text(
                                "Paiement rapide et sécurisé avec MoMo",
                                style: TextStyle(
                              ...
                              Container(
                                ...
                                child: Row(
                                  children: [
                                    ...
                                    Expanded(
                                      child: Text(
                                        "Transaction sécurisée avec MTN MoMo",
                                        style: TextStyle(
        ...
        return AlertDialog(
          ...
          content: Column(
            ...
            children: [
              ...
              const SizedBox(height: 8),
              Text(
                "Votre transaction MTN MoMo a été effectuée avec succès.",
                textAlign: TextAlign.center,
                style: TextStyle(
                  color: Colors.grey[600],
                  fontSize: 14,
